...
class PageSettings(QWidget):
    ...
    def _initDisplay(self):
        ...
        self.ui.comboBox_theme_mode.currentIndexChanged.connect(self._applyThemeMode)
        ...
        self.ui.comboBox_theme_color.currentIndexChanged.connect(self._applyThemeColor)
    ...
    def _initLog(self):
        ...
        """
        flevel_index = self.ui.comboBox_level_file.findText(self.log_util.fLevel.name)
        self.ui.comboBox_level_file.setCurrentIndex(flevel_index)
        self.ui.comboBox_level_file.currentIndexChanged.connect(self._applyLogLevels)

        wlevel_index = self.ui.comboBox_level_window.findText(self.log_util.wLevel.name)
        self.ui.comboBox_level_window.setCurrentIndex(wlevel_index)
        self.ui.comboBox_level_window.currentIndexChanged.connect(self._applyLogLevels)
        ...
        self.ui.pushButton_use_default_path.clicked.connect(self._useDefaultLogPath)
        self.ui.pushButton_open_log_folder.clicked.connect(self._openLogFolder)
