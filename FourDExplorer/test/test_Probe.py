...
class TestProbe(unittest.TestCase):
    def test_camera_length_calculation(self):
        ...
        expected_camera_length = (
            bright_field_disk_radius * detector_pixel_size
        ) / alpha
    ...
    def test_bright_field_disk_radius_calculation(self):
        ...
        expected_bright_field_disk_radius = (
            alpha * camera_length
        ) / detector_pixel_size
        ...
        self.assertAlmostEqual(
            actual_bright_field_disk_radius, expected_bright_field_disk_radius, places=2
        )
    ...
    def test_detector_pixel_size_calculation(self):
        ...
        self.assertAlmostEqual(
            actual_detector_pixel_size, expected_detector_pixel_size, places=2
        )
