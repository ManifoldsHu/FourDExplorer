...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.page_npz.setObjectName("page_npz")
        ...
        self.comboBox_array_name.setObjectName("comboBox_array_name")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.comboBox_array_name.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            QCoreApplication.translate("Form", "Numpy NPY/NPZ file", None)
        )
        self.pushButton_browse_file.setText(
            QCoreApplication.translate("Form", "Browse", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("Form", "The array must be 4-dimensional", None)
        )
        self.label_2.setText(QCoreApplication.translate("Form", "Array Name", None))
