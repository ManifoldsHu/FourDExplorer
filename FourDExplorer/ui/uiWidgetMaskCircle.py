...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.doubleSpinBox_circle_center_j.setObjectName(
            "doubleSpinBox_circle_center_j"
        )
        ...
        self.doubleSpinBox_circle_center_i.setObjectName(
            "doubleSpinBox_circle_center_i"
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label_circle_parameter.setText(
            QCoreApplication.translate("Form", "Circle parameters", None)
        )
        self.groupBox.setTitle(QCoreApplication.translate("Form", "Shape", None))
        self.label_circle_radius.setText(
            QCoreApplication.translate("Form", "Radius (pix)(&R)", None)
        )
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", "Location", None))
        self.label_circle_center_j.setText(
            QCoreApplication.translate("Form", "Horizontal shift(&J)", None)
        )
        self.label_circle_center_i.setText(
