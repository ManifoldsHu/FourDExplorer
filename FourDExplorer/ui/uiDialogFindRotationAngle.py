...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalSpacer = QSpacerItem(
            358, 20, QSizePolicy.Expanding, QSizePolicy.Minimum
        )
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(
            QCoreApplication.translate(
                "Dialog",
                "Find the rotation angle of every vector, corresponding to convergent field.",
                None,
            )
        )
        self.label_3.setText(
            QCoreApplication.translate("Dialog", "Vector field path:", None)
        )
        ...
        self.label.setText(
            QCoreApplication.translate(
                "Dialog",
                "Rotation Angle: Maximum Divergence or Minimum Curl (deg):",
                None,
            )
        )
