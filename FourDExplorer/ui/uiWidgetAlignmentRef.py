...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_measured_dp_shift.setObjectName("label_measured_dp_shift")
        ...
        self.lineEdit_reference_4dstem.setObjectName("lineEdit_reference_4dstem")
        ...
        self.pushButton_browse_reference_4dstem.setObjectName(
            "pushButton_browse_reference_4dstem"
        )
        ...
        self.verticalSpacer_4 = QSpacerItem(
            20, 362, QSizePolicy.Minimum, QSizePolicy.Expanding
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            QCoreApplication.translate("Form", "Measured DP shift:", None)
        )
        self.label_measured_dp_shift.setText(
        ...
        self.label_2.setText(
            QCoreApplication.translate("Form", "Reference 4D-STEM Dataset", None)
        )
        self.pushButton_browse_reference_4dstem.setText(
            QCoreApplication.translate("Form", "Browse", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("Form", "Calculate CoM of Reference", None)
        )
