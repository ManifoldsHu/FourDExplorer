...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_xml_path.setObjectName("lineEdit_xml_path")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "EMPAD XML file", None))
        self.pushButton_browse.setText(
            QCoreApplication.translate("Form", "Browse...", None)
        )
        self.label_2.setText(QCoreApplication.translate("Form", "EMPAD RAW file", None))
