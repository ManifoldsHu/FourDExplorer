...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_line_path.setObjectName("lineEdit_line_path")
        ...
        self.widget_plot_line.setObjectName("widget_plot_line")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.widget_plot_line.sizePolicy().hasHeightForWidth()
        )
        ...
        self.listView_lines.setObjectName("listView_lines")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "Line Path", None))
        self.pushButton_browse.setText(
            QCoreApplication.translate("Form", "Browse", None)
        )
        self.pushButton_add_line.setText(
            QCoreApplication.translate("Form", "Add Line", None)
        )
