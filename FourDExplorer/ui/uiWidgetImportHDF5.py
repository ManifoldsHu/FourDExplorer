...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.treeWidget_other_hdf5.setObjectName("treeWidget_other_hdf5")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "HDF5 File", None))
        self.pushButton_browse.setText(
            QCoreApplication.translate("Form", "Browse", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("Form", "Choose 4D-STEM Dataset to Import", None)
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "Form", "Only 4-dimensional datasets are listed", None
            )
        )
