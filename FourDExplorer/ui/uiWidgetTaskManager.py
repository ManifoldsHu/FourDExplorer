...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_current_task_name.setObjectName("label_current_task_name")
        ...
        self.listView_waiting_queue.setObjectName("listView_waiting_queue")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "Executing Task:", None))
        self.label_current_task_name.setText(
            QCoreApplication.translate("Form", "None", None)
        )
        self.pushButton_detail.setText(
            QCoreApplication.translate("Form", "Details", None)
        )
        self.pushButton_history.setText(
            QCoreApplication.translate("Form", "History Task", None)
        )
