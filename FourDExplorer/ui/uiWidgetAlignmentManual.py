...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_measured_shift.setObjectName("label_measured_shift")
        ...
        self.doubleSpinBox_manual_shift_i.setObjectName("doubleSpinBox_manual_shift_i")
        ...
        self.doubleSpinBox_manual_shift_j.setObjectName("doubleSpinBox_manual_shift_j")
        ...
        self.groupBox_sample_records.setObjectName("groupBox_sample_records")
        ...
        self.tableWidget_manual_sample.setObjectName("tableWidget_manual_sample")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            QCoreApplication.translate("Form", "Measured DP shift (manually):", None)
        )
        self.label_measured_shift.setText(
        ...
        self.label_13.setText(
            QCoreApplication.translate("Form", "Translate DP i-direct", None)
        )
        self.label_14.setText(
            QCoreApplication.translate("Form", "Translate DP j-direct", None)
        )
        self.pushButton_up.setText(QCoreApplication.translate("Form", "\u2191", None))
        self.pushButton_left.setText(QCoreApplication.translate("Form", "\u2190", None))
        self.pushButton_down.setText(QCoreApplication.translate("Form", "\u2193", None))
        self.pushButton_right.setText(
            QCoreApplication.translate("Form", "\u2192", None)
        )
        self.groupBox_sample_records.setTitle(
            QCoreApplication.translate("Form", "Measured DP Shift Sample Records", None)
        )
