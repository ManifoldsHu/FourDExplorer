...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.listView_history_task.setObjectName("listView_history_task")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", "History Tasks", None))
        self.pushButton_refresh.setText(
            QCoreApplication.translate("Dialog", "Refresh", None)
        )
        self.pushButton_clear_all.setText(
            QCoreApplication.translate("Dialog", "Clear All", None)
        )
