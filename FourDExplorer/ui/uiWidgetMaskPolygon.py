...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.doubleSpinBox_polygon_radius.setObjectName("doubleSpinBox_polygon_radius")
        ...
        self.spinBox_vertices_number.setObjectName("spinBox_vertices_number")
        ...
        self.doubleSpinBox_polygon_center_j.setObjectName(
            "doubleSpinBox_polygon_center_j"
        )
        ...
        self.doubleSpinBox_polygon_center_i.setObjectName(
            "doubleSpinBox_polygon_center_i"
        )
        ...
        self.doubleSpinBox_polygon_rotate_angle.setObjectName(
            "doubleSpinBox_polygon_rotate_angle"
        )
        ...
        self.verticalSpacer = QSpacerItem(
            20, 98, QSizePolicy.Minimum, QSizePolicy.Expanding
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            QCoreApplication.translate("Form", "Regular Polygon parameters", None)
        )
        self.groupBox.setTitle(QCoreApplication.translate("Form", "Shape", None))
        self.label_2.setText(QCoreApplication.translate("Form", "Radius", None))
        self.label_3.setText(
            QCoreApplication.translate("Form", "Number of Vertices", None)
        )
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", "Location", None))
        self.label_wedge_center_j.setText(
            QCoreApplication.translate("Form", "Horizontal Shift(&J)", None)
        )
        self.label_wedge_center_i.setText(
            QCoreApplication.translate("Form", "Vertical Shift(&I)", None)
        )
        self.label_wedge_rotate_angle.setText(
