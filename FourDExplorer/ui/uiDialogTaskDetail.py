...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.listView_subtask.setObjectName("listView_subtask")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_task_name.setText(QCoreApplication.translate("Dialog", "None", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", "State:", None))
        self.label_task_state.setText(
            QCoreApplication.translate("Dialog", "Submitted", None)
        )
        self.label_3.setText(QCoreApplication.translate("Dialog", "Comments:", None))
        self.label_6.setText(QCoreApplication.translate("Dialog", "Subtasks", None))
        self.pushButton_refresh.setText(
            QCoreApplication.translate("Dialog", "Refresh", None)
        )
