...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.toolBox_file.setObjectName("toolBox_file")
        self.page_hdf_viewer = WidgetHDFViewer()
        self.page_hdf_viewer.setObjectName("page_hdf_viewer")
        self.page_hdf_viewer.setGeometry(QRect(0, 0, 235, 830))
        self.toolBox_file.addItem(self.page_hdf_viewer, "Hierarchy Data Format")
        self.page_working_directory = QWidget()
        self.page_working_directory.setObjectName("page_working_directory")
        ...
        self.lineEdit_working_directory.setObjectName("lineEdit_working_directory")
        ...
        self.listView_working_directory.setObjectName("listView_working_directory")

        self.verticalLayout.addWidget(self.listView_working_directory)

        self.toolBox_file.addItem(self.page_working_directory, "Working Directory")
    ...
    def retranslateUi(self, Form):
        ...
        self.toolBox_file.setItemText(
            self.toolBox_file.indexOf(self.page_hdf_viewer),
            QCoreApplication.translate("Form", "Hierarchy Data Format", None),
        )
        self.toolBox_file.setItemText(
            self.toolBox_file.indexOf(self.page_working_directory),
            QCoreApplication.translate("Form", "Working Directory", None),
        )
