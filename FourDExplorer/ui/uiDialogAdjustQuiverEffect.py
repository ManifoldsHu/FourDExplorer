...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalSpacer = QSpacerItem(
            20, 65, QSizePolicy.Minimum, QSizePolicy.Expanding
        )
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(
            QCoreApplication.translate(
                "Dialog", "Adjust Vector Field Quiver Display Effect", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate("Dialog", "Arrow Length Scale", None)
        )
        self.label_3.setText(QCoreApplication.translate("Dialog", "Arrow Width", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", "Arrow Color", None))
        self.comboBox_color.setItemText(
            0, QCoreApplication.translate("Dialog", "blue", None)
        )
        self.comboBox_color.setItemText(
            1, QCoreApplication.translate("Dialog", "cyan", None)
        )
        self.comboBox_color.setItemText(
            2, QCoreApplication.translate("Dialog", "green", None)
        )
        self.comboBox_color.setItemText(
            3, QCoreApplication.translate("Dialog", "black", None)
        )
        self.comboBox_color.setItemText(
            4, QCoreApplication.translate("Dialog", "magenta", None)
        )
        self.comboBox_color.setItemText(
            5, QCoreApplication.translate("Dialog", "red", None)
        )
        self.comboBox_color.setItemText(
            6, QCoreApplication.translate("Dialog", "white", None)
        )
        self.comboBox_color.setItemText(
            7, QCoreApplication.translate("Dialog", "yellow", None)
        )
