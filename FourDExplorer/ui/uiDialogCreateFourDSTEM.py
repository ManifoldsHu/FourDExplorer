...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_inplace.setObjectName("checkBox_inplace")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(
            QCoreApplication.translate(
                "Dialog", "Save the output 4D-STEM dataset", None
            )
        )
        self.checkBox_inplace.setText(
            QCoreApplication.translate("Dialog", "Inplace Modification", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("Dialog", "Save the Image to", None)
        )
