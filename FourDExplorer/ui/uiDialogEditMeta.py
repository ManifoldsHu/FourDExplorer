...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_meta_key.setObjectName("lineEdit_meta_key")
        ...
        self.pushButton_browse_item_path.setObjectName("pushButton_browse_item_path")

        self.verticalLayout_3.addWidget(self.pushButton_browse_item_path)

        self.pushButton_browse_meta_key = QPushButton(Dialog)
        self.pushButton_browse_meta_key.setObjectName("pushButton_browse_meta_key")
        ...
        self.label_current_dtype.setObjectName("label_current_dtype")
        ...
        self.pushButton_change_dtype.setObjectName("pushButton_change_dtype")
        ...
        self.stackedWidget_set_value.setObjectName("stackedWidget_set_value")
        self.page_edit_integer = QWidget()
        self.page_edit_integer.setObjectName("page_edit_integer")
        ...
        self.spinBox_edit_integer.setObjectName("spinBox_edit_integer")
        ...
        self.page_edit_float.setObjectName("page_edit_float")
        ...
        self.doubleSpinBox_float_decimal.setObjectName("doubleSpinBox_float_decimal")
        ...
        self.spinBox_float_exp.setObjectName("spinBox_float_exp")
        ...
        self.label_unit_float_hint.setObjectName("label_unit_float_hint")

        self.horizontalLayout_6.addWidget(self.label_unit_float_hint)

        self.label_unit_float = QLabel(self.page_edit_float)
        self.label_unit_float.setObjectName("label_unit_float")
        ...
        self.page_edit_string.setObjectName("page_edit_string")
        ...
        self.plainTextEdit_edit_string.setObjectName("plainTextEdit_edit_string")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(
            QCoreApplication.translate("Dialog", "Edit Metadata", None)
        )
        self.label_2.setText(QCoreApplication.translate("Dialog", "Item Path", None))
        self.label.setText(QCoreApplication.translate("Dialog", "Metadata Key", None))
        self.pushButton_browse_item_path.setText(
            QCoreApplication.translate("Dialog", "Browse", None)
        )
        self.pushButton_browse_meta_key.setText(
            QCoreApplication.translate("Dialog", "Browse", None)
        )
        self.label_7.setText(QCoreApplication.translate("Dialog", "Value Type:", None))
        self.label_current_dtype.setText(
            QCoreApplication.translate("Dialog", "Integer", None)
        )
        self.pushButton_change_dtype.setText(
            QCoreApplication.translate("Dialog", "Change Data Type", None)
        )
        self.label_3.setText(QCoreApplication.translate("Dialog", "Value", None))
        self.label_unit_int_hint.setText(
            QCoreApplication.translate("Dialog", "Unit: ", None)
        )
        self.label_unit_int.setText(
            QCoreApplication.translate("Dialog", "TextLabel", None)
        )
        self.label_4.setText(QCoreApplication.translate("Dialog", "Value", None))
        self.label_5.setText(QCoreApplication.translate("Dialog", "x10^", None))
        self.label_unit_float_hint.setText(
            QCoreApplication.translate("Dialog", "Unit: ", None)
        )
        self.label_unit_float.setText(
            QCoreApplication.translate("Dialog", "TextLabel", None)
        )
        self.label_6.setText(QCoreApplication.translate("Dialog", "Value", None))
        self.label_8.setText(QCoreApplication.translate("Dialog", "Note", None))
