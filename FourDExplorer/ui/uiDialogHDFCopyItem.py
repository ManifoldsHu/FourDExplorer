...
################################################################################
## Form generated from reading UI file 'uiDialogHDFCopyItem.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalSpacer_2 = QSpacerItem(
            20, 26, QSizePolicy.Minimum, QSizePolicy.Expanding
        )
        ...
        self.pushButton_browse_item.setObjectName("pushButton_browse_item")
        ...
        self.verticalSpacer_3 = QSpacerItem(
            20, 25, QSizePolicy.Minimum, QSizePolicy.Expanding
        )
        ...
        self.lineEdit_dest_path.setObjectName("lineEdit_dest_path")

        self.horizontalLayout.addWidget(self.lineEdit_dest_path)

        self.pushButton_browse_dest = QPushButton(Dialog)
        self.pushButton_browse_dest.setObjectName("pushButton_browse_dest")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(
            QCoreApplication.translate(
                "Dialog", "Copy: copy a group or data into a new group.", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate("Dialog", "Item to be copied", None)
        )
        self.pushButton_browse_item.setText(
            QCoreApplication.translate("Dialog", "Browse...", None)
        )
        self.label_3.setText(QCoreApplication.translate("Dialog", "Destination", None))
        self.pushButton_browse_dest.setText(
            QCoreApplication.translate("Dialog", "Browse...", None)
        )
