...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_parent_path.setObjectName("label_parent_path")
        ...
        self.widget_viewer.setObjectName("widget_viewer")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.widget_viewer.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_info.setText(
            QCoreApplication.translate("Dialog", "Browse: choose an item", None)
        )
        self.label_parent_path.setText(
            QCoreApplication.translate("Dialog", "Parent Path", None)
        )
