...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_vector_path.setObjectName("lineEdit_vector_path")
        ...
        self.widget_quiver.setObjectName("widget_quiver")
        ...
        self.checkBox_background_visible.setObjectName("checkBox_background_visible")
        ...
        self.pushButton_show_stream_line.setObjectName("pushButton_show_stream_line")
        ...
        self.pushButton_show_color_wheel.setObjectName("pushButton_show_color_wheel")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_browse_background.setText(
            QCoreApplication.translate("Form", "Browse Background", None)
        )
        self.checkBox_background_visible.setText(
            QCoreApplication.translate("Form", "Background Image Visible", None)
        )
        self.pushButton_adjust_effects.setText(
            QCoreApplication.translate("Form", "Adjust Quiver Effects...", None)
        )
        self.pushButton_show_stream_line.setText(
            QCoreApplication.translate("Form", "Show Stream Line Image...", None)
        )
        self.pushButton_show_color_wheel.setText(
            QCoreApplication.translate("Form", "Show Color Wheel Image...", None)
        )
