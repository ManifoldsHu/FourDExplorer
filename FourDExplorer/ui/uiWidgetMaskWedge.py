...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.doubleSpinBox_wedge_open_angle.setObjectName(
            "doubleSpinBox_wedge_open_angle"
        )
        ...
        self.doubleSpinBox_wedge_rotate_angle.setObjectName(
            "doubleSpinBox_wedge_rotate_angle"
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label_wedge_parameter.setText(
            QCoreApplication.translate("Form", "Wedge parameters", None)
        )
        self.groupBox.setTitle(QCoreApplication.translate("Form", "Shape", None))
        self.label_wedge_inner.setText(
            QCoreApplication.translate("Form", "Inner Radius (pix)(&I)", None)
        )
        self.label_wedge_outer.setText(
            QCoreApplication.translate("Form", "Outer Radius (pix)(&O)", None)
        )
        self.label_wedge_open_angle.setText(
