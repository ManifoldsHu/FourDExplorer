...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget_meta_viewer.setObjectName("widget_meta_viewer")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.widget_meta_viewer.sizePolicy().hasHeightForWidth()
        )
        ...
        self.tab_not_pathlike.setObjectName("tab_not_pathlike")
        self.verticalLayout_2 = QVBoxLayout(self.tab_not_pathlike)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.widget_meta_viewer_not_pathlike = WidgetMetaViewerBaseNotPathlike(
            self.tab_not_pathlike
        )
        self.widget_meta_viewer_not_pathlike.setObjectName(
            "widget_meta_viewer_not_pathlike"
        )
        sizePolicy.setHeightForWidth(
            self.widget_meta_viewer_not_pathlike.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.tabWidget.setTabText(
            ...
            QCoreApplication.translate("Form", "Predefined Metadata", None),
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_not_pathlike),
            QCoreApplication.translate("Form", "Other Metadata", None),
        )
