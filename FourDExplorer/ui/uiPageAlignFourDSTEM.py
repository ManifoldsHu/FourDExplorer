...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tab_diffraction_shift_alignment.setObjectName(
            "tab_diffraction_shift_alignment"
        )
        ...
        self.comboBox_show_alignment_method = QComboBox(
            self.tab_diffraction_shift_alignment
        )
        self.comboBox_show_alignment_method.addItem("")
        self.comboBox_show_alignment_method.addItem("")
        self.comboBox_show_alignment_method.addItem("")
        self.comboBox_show_alignment_method.setObjectName(
            "comboBox_show_alignment_method"
        )
        ...
        self.stackedWidget_align_mode = QStackedWidget(
            self.tab_diffraction_shift_alignment
        )
        self.stackedWidget_align_mode.setObjectName("stackedWidget_align_mode")
        self.stackedWidget_align_mode_manually = WidgetAlignmentManual()
        self.stackedWidget_align_mode_manually.setObjectName(
            "stackedWidget_align_mode_manually"
        )
        ...
        self.stackedWidget_align_mode_reference.setObjectName(
            "stackedWidget_align_mode_reference"
        )
        ...
        self.stackedWidget_align_mode_fddnet.setObjectName(
            "stackedWidget_align_mode_fddnet"
        )
        ...
        self.tab_displaying_effects.setObjectName("tab_displaying_effects")
        ...
        self.lineEdit_shift_mapping_path.setObjectName("lineEdit_shift_mapping_path")
        ...
        self.pushButton_browse_shift_mapping.setObjectName(
            "pushButton_browse_shift_mapping"
        )
        ...
        self.checkBox_draw_auxiliary_arrow.setObjectName(
            "checkBox_draw_auxiliary_arrow"
        )
        ...
        self.comboBox_auxiliary_arrow_color.addItem("")
        self.comboBox_auxiliary_arrow_color.addItem("")
        self.comboBox_auxiliary_arrow_color.setObjectName(
            "comboBox_auxiliary_arrow_color"
        )
        ...
        self.doubleSpinBox_auxiliary_arrow_width.setObjectName(
            "doubleSpinBox_auxiliary_arrow_width"
        )
        ...
        self.widget_auxiliary_circle.setObjectName("widget_auxiliary_circle")
        ...
        self.label_current_auxiliary_circle_center.setObjectName(
            "label_current_auxiliary_circle_center"
        )
        ...
        self.checkBox_set_auxiliary_circle_center_to_shift.setObjectName(
            "checkBox_set_auxiliary_circle_center_to_shift"
        )

        self.verticalLayout_5.addWidget(
            self.checkBox_set_auxiliary_circle_center_to_shift
        )

        self.checkBox_show_auxiliary_circle = QCheckBox(self.groupBox)
        self.checkBox_show_auxiliary_circle.setObjectName(
            "checkBox_show_auxiliary_circle"
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label_10.setText(
            QCoreApplication.translate("Form", "Alignment Method", None)
        )
        self.comboBox_show_alignment_method.setItemText(
            0, QCoreApplication.translate("Form", "Manually", None)
        )
        self.comboBox_show_alignment_method.setItemText(
            1, QCoreApplication.translate("Form", "Use Reference Dataset", None)
        )
        self.comboBox_show_alignment_method.setItemText(
            2, QCoreApplication.translate("Form", "Use FDDNet", None)
        )

        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_diffraction_shift_alignment),
            QCoreApplication.translate("Form", "Diffraction Shift Alignment", None),
        )
        self.label_13.setText(
            QCoreApplication.translate("Form", "Shift Mapping Path", None)
        )
        self.pushButton_browse_shift_mapping.setText(
            QCoreApplication.translate("Form", "Browse", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("Form", "Auxiliary Arrow", None)
        )
        self.checkBox_draw_auxiliary_arrow.setText(
            QCoreApplication.translate("Form", "Draw shift arrow at the center", None)
        )
        self.label_14.setText(QCoreApplication.translate("Form", "Arrow Color", None))
        self.label_15.setText(QCoreApplication.translate("Form", "Arrow Width", None))
        self.comboBox_auxiliary_arrow_color.setItemText(
            0, QCoreApplication.translate("Form", "black", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            1, QCoreApplication.translate("Form", "blue", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            2, QCoreApplication.translate("Form", "cyan", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            3, QCoreApplication.translate("Form", "green", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            4, QCoreApplication.translate("Form", "orange", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            5, QCoreApplication.translate("Form", "purple", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            6, QCoreApplication.translate("Form", "red", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            7, QCoreApplication.translate("Form", "white", None)
        )
        self.comboBox_auxiliary_arrow_color.setItemText(
            8, QCoreApplication.translate("Form", "yellow", None)
        )

        self.groupBox.setTitle(
            QCoreApplication.translate("Form", "Auxiliary Circle", None)
        )
        self.label_9.setText(
            QCoreApplication.translate("Form", "Current Circle Center", None)
        )
        self.label_current_auxiliary_circle_center.setText(
            QCoreApplication.translate("Form", "(0, 0)", None)
        )
        self.checkBox_set_auxiliary_circle_center_to_shift.setText(
            QCoreApplication.translate(
                "Form", "Set circle center to where the shift vector point to", None
            )
        )
        self.checkBox_show_auxiliary_circle.setText(
            QCoreApplication.translate("Form", "Show auxiliary circle", None)
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_displaying_effects),
            QCoreApplication.translate("Form", "Displaying Effects", None),
        )
        self.pushButton_start.setText(
            QCoreApplication.translate(
                "Form",
                "Start Calculation (Applying Shift Vector to 4D-STEM Dataset)",
                None,
            )
        )
