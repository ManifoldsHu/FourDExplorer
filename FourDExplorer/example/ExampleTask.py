...
class ExampleSleep(Task):
    ...
    def __init__(self, parent=None):
        ...
        self.setFollow(
            QMessageBox.information, None, "follow", "I wake up", QMessageBox.Ok
        )
...
class ExampleSleepWithoutProgress(Task):
    ...
    def __init__(self, parent: QObject = None):
        ...
        self.calc_subtask = self.addSubtaskFunc("Calculation", self.calculation, 100)

        self.setPrepare(self.showPrepareMessage)

        self.setFollow(self.showFollowMessage)
    ...
    def showFollowMessage(self):
        QMessageBox.information(
            None,
            "follow",
            "I calculated from 0 to 99: {0}".format(self.calc_subtask.result),
            QMessageBox.Ok,
        )
        # raise Exception('An exception occured')
