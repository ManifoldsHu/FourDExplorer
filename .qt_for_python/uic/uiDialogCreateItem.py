...
################################################################################
## Form generated from reading UI file 'uiDialogCreateItem.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_type.setItemText(2, QCoreApplication.translate("Dialog", u"Line", None))
        self.comboBox_type.setItemText(3, QCoreApplication.translate("Dialog", u"Image", None))
        self.comboBox_type.setItemText(4, QCoreApplication.translate("Dialog", u"4D-STEM Dataset", None))
