...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Copy: copy a group or data into a new group.", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Item to be copied", None))
