...
from bin.Widgets.Masks import (WidgetMaskCircle, WidgetMaskRectangle, WidgetMaskRing, WidgetMaskSegment2,
    WidgetMaskSegment4, WidgetMaskSegment6, WidgetMaskSegment8, WidgetMaskWedge)
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 510, 501))
        ...
        self.page_segment_2 = WidgetMaskSegment2()
        self.page_segment_2.setObjectName(u"page_segment_2")
        self.stackedWidget_masks.addWidget(self.page_segment_2)
        self.page_segment_4 = WidgetMaskSegment4()
        self.page_segment_4.setObjectName(u"page_segment_4")
        self.stackedWidget_masks.addWidget(self.page_segment_4)
        self.page_segment_6 = WidgetMaskSegment6()
        self.page_segment_6.setObjectName(u"page_segment_6")
        self.stackedWidget_masks.addWidget(self.page_segment_6)
        self.page_segment_8 = WidgetMaskSegment8()
        self.page_segment_8.setObjectName(u"page_segment_8")
        self.stackedWidget_masks.addWidget(self.page_segment_8)
        ...
        self.stackedWidget_masks.setCurrentIndex(3)
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_mode.setItemText(3, QCoreApplication.translate("Form", u"Segmented Ring (2 pieces)", None))
        self.comboBox_mode.setItemText(4, QCoreApplication.translate("Form", u"Segmented Ring (4 pieces)", None))
        self.comboBox_mode.setItemText(5, QCoreApplication.translate("Form", u"Segmented Ring (6 pieces)", None))
        self.comboBox_mode.setItemText(6, QCoreApplication.translate("Form", u"Segmented Ring (8 pieces)", None))
