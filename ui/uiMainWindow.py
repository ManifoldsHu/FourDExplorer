...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget_control.setMinimumSize(QSize(0, 0))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 992, 944))
        ...
        self.tabWidget_view.setMinimumSize(QSize(0, 0))
